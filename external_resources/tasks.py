...
from main.celery import STATUS_CODE_WHITELIST, app
from websites.constants import CONTENT_TYPE_EXTERNAL_RESOURCE
from websites.models import WebsiteContent


@app.task(acks_late=True, rate_limit="100/s", priority=1)
def check_external_resources_for_breakage(resource: str):
    """Check external resources for broken link"""
    try:
    ...
    try:
        ...
        if (
            ...
            if is_url_broken and is_backup_url_broken:
                # external_url and backup_url are broken.
...
def check_external_resources_for_breakages():
    ...
    for resource in external_resources:
        check_external_resources_for_breakage.delay(resource)
