...
def init_sentry(*, dsn, environment, version, log_level, heroku_app_name):
    ...
    sentry_sdk.init(
        ...
        # unset it defaults to "medium", i.e. 10,000-byte bodies -- website
        # content edits, collaborator email addresses, and the Concourse and
        # GitHub webhook payloads.  Set explicitly so the choice is findable
        # here rather than in a dependency's defaults.
