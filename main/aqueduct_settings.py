...
class AqueductSettings(BaseSettings):
    ...
    AUTHENTICATION_BACKENDS: tuple[Any, ...] = Field(default=('social_core.backends.keycloak.KeycloakOAuth2', 'django.contrib.auth.backends.ModelBackend', 'guardian.backends.ObjectPermissionBackend'))  # TODO: refine type
    AUTH_USER_MODEL: str = Field(default='users.User', description='configure a custom user model')
    ...
    AWS_ARTIFACTS_BUCKET_NAME: str | None = Field(default=None, validation_alias=AliasChoices('AWS_ARTIFACTS_BUCKET_NAME'))
    AWS_DEFAULT_ACL: str = Field(default='public-read')
    AWS_IMPORT_STORAGE_BUCKET_NAME: str | None = Field(default=None, validation_alias=AliasChoices('AWS_IMPORT_STORAGE_BUCKET_NAME'))
    AWS_MAX_CONCURRENT_CONNECTIONS: int = Field(default=10, validation_alias=AliasChoices('AWS_MAX_CONCURRENT_CONNECTIONS'))
    AWS_OFFLINE_PREVIEW_BUCKET_NAME: str | None = Field(default=None, validation_alias=AliasChoices('AWS_OFFLINE_PREVIEW_BUCKET_NAME'))
    AWS_OFFLINE_PUBLISH_BUCKET_NAME: str | None = Field(default=None, validation_alias=AliasChoices('AWS_OFFLINE_PUBLISH_BUCKET_NAME'))
    AWS_OFFLINE_TEST_BUCKET_NAME: str | None = Field(default=None, validation_alias=AliasChoices('AWS_OFFLINE_TEST_BUCKET_NAME'))
    AWS_PREVIEW_BUCKET_NAME: str | None = Field(default=None, validation_alias=AliasChoices('AWS_PREVIEW_BUCKET_NAME'))
    AWS_PUBLISH_BUCKET_NAME: str | None = Field(default=None, validation_alias=AliasChoices('AWS_PUBLISH_BUCKET_NAME'))
    AWS_QUERYSTRING_AUTH: bool = Field(default=False, validation_alias=AliasChoices('AWS_QUERYSTRING_AUTH'))
    AWS_REGION: str = Field(default='us-east-1', validation_alias=AliasChoices('AWS_REGION'))
    AWS_ROLE_NAME: str | None = Field(default=None, validation_alias=AliasChoices('AWS_ROLE_NAME'))
    AWS_S3_SYNC_INTERVAL: str = Field(default='24h', validation_alias=AliasChoices('AWS_S3_SYNC_INTERVAL'))
    ...
    AWS_STORAGE_BUCKET_NAME: str | None = Field(default=None, validation_alias=AliasChoices('AWS_STORAGE_BUCKET_NAME'))
    ...
    CHECK_EXTERNAL_RESOURCE_STATUS_FREQUENCY: int = Field(default=604800, validation_alias=AliasChoices('CHECK_EXTERNAL_RESOURCE_STATUS_FREQUENCY'), description='Check External Resources settings')
    CONCOURSE_HARD_PURGE: bool = Field(default=True, validation_alias=AliasChoices('CONCOURSE_HARD_PURGE'))
    ...
    DISABLE_WEBPACK_LOADER_STATS: bool = Field(default=False, validation_alias=AliasChoices('DISABLE_WEBPACK_LOADER_STATS'))
    ...
    DRIVE_S3_UPLOAD_PREFIX: str = Field(default='gdrive_uploads', validation_alias=AliasChoices('DRIVE_S3_UPLOAD_PREFIX'))
    DRIVE_SERVICE_ACCOUNT_CREDS: str | None = Field(default=None, validation_alias=AliasChoices('DRIVE_SERVICE_ACCOUNT_CREDS'), description='Google Drive and Video settings')
    DRIVE_SHARED_ID: str | None = Field(default=None, validation_alias=AliasChoices('DRIVE_SHARED_ID'))
    DRIVE_UPLOADS_PARENT_FOLDER_ID: str | None = Field(default=None, validation_alias=AliasChoices('DRIVE_UPLOADS_PARENT_FOLDER_ID'))
    ENABLE_CHECK_EXTERNAL_RESOURCE_TASK: bool = Field(default=True, validation_alias=AliasChoices('CHECK_EXTERNAL_RESOURCE_TASK_STATUS'))
    ENABLE_WAYBACK_TASKS: bool = Field(default=False, validation_alias=AliasChoices('ENABLE_WAYBACK_TASKS'), description='Wayback Machine Settings')
    ENVIRONMENT: str = Field(..., validation_alias=AliasChoices('OCW_STUDIO_ENVIRONMENT'), description='Sentry')
    ...
    FEATURES_DEFAULT: bool = Field(default=False, validation_alias=AliasChoices('FEATURES_DEFAULT'))
    FIELD_METADATA_TITLE: str = Field(default='course_title', validation_alias=AliasChoices('FIELD_METADATA_TITLE'))
    FIELD_RESOURCETYPE: str = Field(default='resourcetype', validation_alias=AliasChoices('FIELD_RESOURCETYPE'), description='OCW metadata fields')
    GA_TRACKING_ID: str = Field(default='', validation_alias=AliasChoices('GA_TRACKING_ID'))
    GITHUB_APP_ID: int | None = Field(default=None, validation_alias=AliasChoices('GITHUB_APP_ID'))
    GITHUB_APP_PRIVATE_KEY: str | None = Field(default=None)  # REDACTED: name looks secret-like — set via a source, not here
    GITHUB_RATE_LIMIT_CHECK: bool = Field(default=False, validation_alias=AliasChoices('GITHUB_RATE_LIMIT_CHECK'))
    GITHUB_RATE_LIMIT_CUTOFF: int = Field(default=100, validation_alias=AliasChoices('GITHUB_RATE_LIMIT_CUTOFF'))
    GITHUB_RATE_LIMIT_MIN_SLEEP: int = Field(default=5, validation_alias=AliasChoices('GITHUB_RATE_LIMIT_MIN_SLEEP'))
    ...
    GIT_DEFAULT_USER_EMAIL: str = Field(default='anonymous@example.edu', validation_alias=AliasChoices('GIT_DEFAULT_USER_EMAIL'))
    GIT_DEFAULT_USER_NAME: str = Field(default='Anonymous', validation_alias=AliasChoices('GIT_DEFAULT_USER_NAME'))
    ...
    OCW_EXTRA_THEMES_GTM_IDS: Any = Field(default_factory=lambda: get_dict_of_str(
    name="OCW_EXTRA_THEMES_GTM_IDS",
    default={},
))  # TODO: refine type
    OCW_GTM_ACCOUNT_ID: str | None = Field(default=None, validation_alias=AliasChoices('OCW_GTM_ACCOUNT_ID'))
    OCW_HUGO_PROJECTS_BRANCH: str | None = Field(default=None, validation_alias=AliasChoices('OCW_HUGO_PROJECTS_BRANCH'))
    OCW_HUGO_THEMES_BRANCH: str | None = Field(default=None, validation_alias=AliasChoices('OCW_HUGO_THEMES_BRANCH'))
    OCW_HUGO_THEMES_SENTRY_DSN: str | None = Field(default=None, validation_alias=AliasChoices('OCW_HUGO_THEMES_SENTRY_DSN'))  # REDACTED: name looks secret-like — set via a source, not here
    ...
    PUBLISH_POSTHOG_PROJECT_API_KEY: str | None = Field(default=None, validation_alias=AliasChoices('PUBLISH_POSTHOG_PROJECT_API_KEY'))  # REDACTED: name looks secret-like — set via a source, not here
    ...
    SITEMAP_DOMAIN: str = Field(default='ocw.mit.edu', validation_alias=AliasChoices('SITEMAP_DOMAIN'))
    ...
    TEST_ROOT_WEBSITE_NAME: str = Field(default='ocw-ci-test-www', validation_alias=AliasChoices('TEST_ROOT_WEBSITE_NAME'))
    THREEPLAY_API_KEY: str | None = Field(default=None, validation_alias=AliasChoices('THREEPLAY_API_KEY'))  # REDACTED: name looks secret-like — set via a source, not here
    THREEPLAY_BASE_TIMEOUT: int = Field(default=15, validation_alias=AliasChoices('THREEPLAY_BASE_TIMEOUT'))
    THREEPLAY_CALLBACK_KEY: str | None = Field(default=None, validation_alias=AliasChoices('THREEPLAY_CALLBACK_KEY'))
    THREEPLAY_PROJECT_ID: int = Field(default=2, validation_alias=AliasChoices('THREEPLAY_PROJECT_ID'))
    TIME_ZONE: str = Field(default='UTC')
    UPDATE_MISSING_TRANSCRIPT_FREQUENCY: int = Field(default=43200, validation_alias=AliasChoices('UPDATE_MISSING_TRANSCRIPT_FREQUENCY'))
    UPDATE_TAGGED_3PLAY_TRANSCRIPT_FREQUENCY: int = Field(default=3600, validation_alias=AliasChoices('UPDATE_TAGGED_3PLAY_TRANSCRIPT_FREQUENCY'))
    UPDATE_WAYBACK_JOBS_STATUS_FREQUENCY: int = Field(default=21600, validation_alias=AliasChoices('UPDATE_WAYBACK_JOBS_STATUS_FREQUENCY'))
    ...
    WAYBACK_MACHINE_ACCESS_KEY: str | None = Field(default=None, validation_alias=AliasChoices('WAYBACK_MACHINE_ACCESS_KEY'), description='Wayback Machine API Credentials')  # REDACTED: name looks secret-like — set via a source, not here
    WAYBACK_MACHINE_SECRET_KEY: str | None = Field(default=None, validation_alias=AliasChoices('WAYBACK_MACHINE_SECRET_KEY'))  # REDACTED: name looks secret-like — set via a source, not here
    WAYBACK_SUBMISSION_INTERVAL_DAYS: int = Field(default=30, validation_alias=AliasChoices('WAYBACK_SUBMISSION_INTERVAL_DAYS'))
    ...
    YT_ACCESS_TOKEN: str | None = Field(default=None, validation_alias=AliasChoices('YT_ACCESS_TOKEN'))  # REDACTED: name looks secret-like — set via a source, not here
    YT_CATEGORY_ID: int = Field(default=27, validation_alias=AliasChoices('YT_CATEGORY_ID'))
    YT_CLIENT_ID: str = Field(default='', validation_alias=AliasChoices('YT_CLIENT_ID'))
    YT_CLIENT_SECRET: str | None = Field(default=None, validation_alias=AliasChoices('YT_CLIENT_SECRET'))  # REDACTED: name looks secret-like — set via a source, not here
    YT_FIELD_CAPTIONS: str = Field(default='video_files.video_captions_file', validation_alias=AliasChoices('YT_FIELD_CAPTIONS'), description='YouTube OCW metadata fields')
    YT_FIELD_CAPTIONS_RESOURCE: str = Field(default='video_files.video_captions_resource', validation_alias=AliasChoices('YT_FIELD_CAPTIONS_RESOURCE'))
    YT_FIELD_DESCRIPTION: str = Field(default='video_metadata.youtube_description', validation_alias=AliasChoices('YT_FIELD_DESCRIPTION'))
    YT_FIELD_ID: str = Field(default='video_metadata.youtube_id', validation_alias=AliasChoices('YT_FIELD_ID'))
    YT_FIELD_SPEAKERS: str = Field(default='video_metadata.video_speakers', validation_alias=AliasChoices('YT_FIELD_SPEAKERS'))
    YT_FIELD_TAGS: str = Field(default='video_metadata.video_tags', validation_alias=AliasChoices('YT_FIELD_TAGS'))
    YT_FIELD_THUMBNAIL: str = Field(default='video_files.video_thumbnail_file', validation_alias=AliasChoices('YT_FIELD_THUMBNAIL'))
    YT_FIELD_TRANSCRIPT: str = Field(default='video_files.video_transcript_file', validation_alias=AliasChoices('YT_FIELD_TRANSCRIPT'))
    YT_FIELD_TRANSCRIPT_RESOURCE: str = Field(default='video_files.video_transcript_resource', validation_alias=AliasChoices('YT_FIELD_TRANSCRIPT_RESOURCE'))
    YT_PROJECT_ID: str = Field(default='', validation_alias=AliasChoices('YT_PROJECT_ID'))
    YT_REFRESH_TOKEN: str | None = Field(default=None, validation_alias=AliasChoices('YT_REFRESH_TOKEN'))  # REDACTED: name looks secret-like — set via a source, not here
    YT_STATUS_UPDATE_FREQUENCY: int = Field(default=60, validation_alias=AliasChoices('YT_STATUS_UPDATE_FREQUENCY'))
    ...
    WEBPACK_DISABLE_LOADER_STATS: bool = Field(default=False, validation_alias=AliasChoices('WEBPACK_DISABLE_LOADER_STATS'))
    ...
    EMAIL_HOST_PASSWORD: str | None = Field(default=None)  # REDACTED: name looks secret-like — set via a source, not here
    EMAIL_HOST_USER: str = Field(default='')
    EMAIL_PORT: int = Field(default=25)
    EMAIL_RECIPIENT_OVERRIDE: str | None = Field(default=None, validation_alias=AliasChoices('EMAIL_RECIPIENT_OVERRIDE'))  # DERIVED: reproduce in a @model_validator (conditional/computed value)
    EMAIL_SUPPORT: str | None = Field(default=None)  # DERIVED: reproduce in a @model_validator (conditional/computed value)
    ...
    VIDEO_S3_TRANSCODE_BUCKET: str = Field(default='', validation_alias=AliasChoices('VIDEO_S3_TRANSCODE_BUCKET'))
    VIDEO_S3_TRANSCODE_ENDPOINT: str = Field(default='aws_mediaconvert_transcodes', validation_alias=AliasChoices('VIDEO_S3_TRANSCODE_ENDPOINT'))
    VIDEO_S3_TRANSCODE_PREFIX: str = Field(default='', validation_alias=AliasChoices('VIDEO_S3_TRANSCODE_PREFIX'))
