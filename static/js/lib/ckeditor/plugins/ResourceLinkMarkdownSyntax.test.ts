...
describe("ResourceLink plugin", () => {
  ...
  it("should not mash an anchor hash thingy", async () => {
    ...
    markdownTest(
      ...
      `<p><a class="resource-link" data-link-attrs="${encode(
        "1234-5678",
        "#some-header-id"
      )}">link text</a></p>`
    )
  ...
  it("should serialize multiple links to and from markdown", async () => {
    ...
    markdownTest(
      ...
      `<p>dogs <a class="resource-link" data-link-attrs="${encode(
        "uuid1"
      )}">woof</a> cats <a class="resource-link" data-link-attrs="${encode(
        "uuid2"
      )}">meow</a>, cool</p>`
    )
  })
