...
export default function PrivacyPolicyPage(): JSX.Element | null {
  return (
    <div className="privacy-policy-page m-5">
      ...
      <h3>Introduction</h3>
      <p>
        OCW Studio is a tool for members of the MIT community to create courses
        and resources for the MIT OpenCourseWare site.
      </p>
      ...
      <p>
        We collect information, including Personal Information, when you create
        an account and login. We also collect certain usage information as you
        create and edit courses. In addition, we track information indicating,
        among other things, which pages of our Site were visited, the order in
        which they were visited, when they were visited, and which hyperlinks
        and other user interface controls were used.
      </p>
      <p>
      ...
      <p>
        ...
        transactions requested by you and meet our contractual obligations; (2)
        to facilitate MIT OpenCourseWare’s legitimate interests, and/or (3) with
        your explicit consent, where applicable. Examples of the ways in which
        we use your personal information are as follows:
      </p>
      <ul>
        <li>
          To enable us to create, provide, administer, and improve our courses.
        </li>
        <li>To help us improve MIT OpenCourseWare program.</li>
        <li>
        ...
        <li>
          ...
          for example, to respond to a specific inquiry or provide you with
          access to the specific course content and/or services you select.
        </li>
        <li>
          To maintain and improve the functioning and security of the Site and
          our software, systems, and network.
        </li>
        <li>
      ...
      <p>
        We will share information we collect (including Personal Information)
        with third parties as follows:
      </p>
      <ul>
        <li>
          With service providers or contractors that perform certain functions
          on our behalf, including processing information that you provide to us
        ...
        <li>
          For purposes of scientific research, particularly, for example, in the
          areas of cognitive science and education. However, we will only share
          Personal Information about you for this purpose to the extent doing so
          complies with applicable law and is limited to the Personal
          Information required to fulfill the purposes stated at the time of
          collection.
        </li>
        <li>
          ...
          suspected fraud, or security or technical issues, or to enforce our
          Terms of Service, our Honor Code, or this Privacy Policy; as otherwise
          may be required by applicable law; or to protect our rights, property,
          or safety or those of others.
        </li>
        <li>
          As otherwise described to you at the point of collection or pursuant
          to your consent.
        ...
        <li>
          To support integration with third party services. For example, videos
          and other content may be hosted on YouTube and other websites not
          controlled by us.
        </li>
      </ul>
      <p>
        In cases where we share or disclose your Personal Information: (1) the
        third party recipients are required to handle the Personal Information
        in a confidential manner and to maintain adequate security to protect
        the information from loss, misuse, unauthorized access or disclosure,
        alteration, and destruction; and (2) we will only disclose and share the
        Personal Information that is required by the third party to fulfill the
        purpose stated at the time of collection. In addition, we may share
        aggregated information that does not personally identify you with the
      ...
      <p>
        MIT is dedicated to protecting Personal Information in its possession or
        control. This is done through a variety of privacy and security
        ...
        that it receives, maintains, or transmits. Nonetheless, no method of
        transmission over the Internet or method of electronic storage is 100%
        secure, and therefore we do not guarantee its absolute security.
      </p>
      ...
      <p>
        ...
        information; (2) to correct or erase information; (3) restrict
        processing; and (4) object to communications, direct marketing, or
        profiling. To the extent applicable, the EU’s General Data Protection
        Regulation provides further information about your rights. You also have
        the right to lodge complaints with your national or regional data
      ...
      <p>
        ...
        information, we will maintain a core set of personal data to ensure we
        do not contact you inadvertently in the future, as well as any
        information necessary for MIT archival purposes. We may also need to
        retain some financial information for legal purposes, including US IRS
        compliance. In the event of an actual or threatened legal claim, we may
        retain your information for purposes of establishing, defending against
        or exercising our rights with respect to such claim.
      </p>
      <p>
