...
class Command(BaseCommand):
    """Link the video resource with the UUID video_uuid to the transcript resource with transcript_uuid"""
    ...
    def add_arguments(self, parser):
        ...
        parser.add_argument(
            ...
            help="text_id of transcript resource object to be linked",
            required=True,
        )
    ...
    def handle(self, *args, **options):
        ...
        video.save()
        self.stdout.write("Transcript successfully linked to video.\n")
